...
public class Ttetrimino extends Tetrimino{
    ...
    public void rotate() {
        switch (rotate_state){
            case 0:
                if (blocks[1].getY() > GAME.MAX_Y-GAME.SIZE*2)
                    break;
            ...
            case 3:
                ...
                if(blocks[1].getX() > GAME.MAX_X-2* GAME.SIZE)
                    break;
